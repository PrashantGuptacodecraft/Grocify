  ...
  return (
    <footer id="footer" className="bg-zinc-800 text-white mt-20 pt-16 pb-8">
      <div className="max-w-[1400px] mx-auto px-10 grid md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-zinc-400">
            Delivering the freshest organic produce directly to your doorstep.
        ...
        <div>
          ...
          <ul className="space-y-4 text-zinc-400">
            ...
            <li>Email: prashant983869@gmail.com</li>
            <li>Phone: 9838693305</li>
          </ul>
        </div>
        <div>
          ...
          {subscribed ? (
            ...
            <form className="flex" onSubmit={handleSubscribe}>
              ...
              <button
                type="submit"
                className="bg-orange-500 px-4 py-2 rounded-r-lg font-bold hover:bg-orange-600 transition"
              >
                Go
              </button>
            </form>
      ...
      <div className="max-w-[1400px] mx-auto px-10 mt-16 pt-8 border-t border-zinc-700 text-center text-zinc-500">
        <p>
          &copy; {new Date().getFullYear()} Grocify. All rights reserved. Final
          Project.
        </p>
      </div>
    </footer>
